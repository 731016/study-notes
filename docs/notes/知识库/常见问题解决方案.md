...
#### window启动脚本
```cmd
start cmd /k "java -jar D:\projects\xx\xxx.jar --spring.config.location=file:D:\projects\xx\application-Prod.yml"
```

#### linux启动脚本
```bash
java -jar home/projects/xx/xxx.jar --spring.config.location=file:D:/projects/xx/application-Prod.yml
```